...
//Peticion datos
  $peticion = "SELECT * FROM usuario Where id =". $id;
...
<div class="hero-unit">
    ...
    <div class="row text-center">
              <form method="POST" action="controller/cuenta.php" class="form-horizontal">
                 <fieldset>
                <legend><p class="text-left">cuenta</p></legend>
                  <div class="form-group">
                  <label for="inputNombre" class="col-lg-2 control-label">Nombre Usuario</label>
                    <div class="col-lg-6">
                      <input type="text" name="user" value="<?php echo $user; ?>" class="form-control" id="inputNombre" style="height:40px">
                    </div>
                  </div>
                  <div class="form-group">
                   <label for="inputContraseña" class="col-lg-2 control-label">Contrase&ntildea</label>
                    <div class="col-lg-6">
                      <input type="Numero" name="password" value="<?php echo $password; ?>" class="form-control" id="inputNumero" style="height:40px">
                    </div>
                  </div>
